...
Доступ к API, как и к самому ChatGPT заблокирован в России. К счастью, есть простое решение этой проблемы - [ChatGPT API в России от компании ProxyAPI](https://proxyapi.ru/). Не нужен ни иностранный телефон, ни VPN, ни карта иностранного банка.
Полная документация по данному сервису [по ссылке](https://openai-docs.ru/docs) 
